...
```{r, echo=FALSE}
# Bike data
bikes_tbl      <- readRDS("D:/Machine_learning(TUHH)/data_products-cpl5238/01_data/bikes_tbl.rds")
bikeshops_tbl  <- readRDS("D:/Machine_learning(TUHH)/data_products-cpl5238/01_data/bikeshops_tbl.rds")
orderlines_tbl <- readRDS("D:/Machine_learning(TUHH)/data_products-cpl5238/01_data/orderlines_tbl.rds")
